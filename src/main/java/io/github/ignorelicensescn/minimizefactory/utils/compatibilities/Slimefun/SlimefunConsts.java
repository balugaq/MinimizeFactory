...
public class SlimefunConsts {
     ...
     */
    public static final Map<World.Environment,Map<Biome,SimplePair<ItemStack[],IntegerRational[]>>> geoResourcesInfo = new HashMap<>();
    public static final Map<World.Environment,Map<Biome,SimplePair<ItemStack[], IntegerRational[]>>> geoMinerResourcesInfo = new HashMap<>();

    /**
     * more useful maps for information
     */
    public static final Map<ItemStack, List<SimplePair<BiomeAndEnvironment, IntegerRational>>> geoResourcesInfo_ResourcesKey = new HashMap<>();
    public static final Map<ItemStack, List<SimplePair<BiomeAndEnvironment, IntegerRational>>> geoMinerResourcesInfo_ResourcesKey = new HashMap<>();
    public static final List<SimplePair<ItemStack, List<SimplePair<BiomeAndEnvironment, IntegerRational>>>> geoResourcesInfo_ResourcesList = new ArrayList<>();
    public static final List<SimplePair<ItemStack, List<SimplePair<BiomeAndEnvironment, IntegerRational>>>> geoMinerResourcesInfo_ResourcesList = new ArrayList<>();

    public static final Map<BiomeAndEnvironment,SimplePair<ItemStack[],IntegerRational[]>> geoResourcesInfo_BiomeAndEnvironmentKey = new HashMap<>();
    public static final Map<BiomeAndEnvironment,SimplePair<ItemStack[],IntegerRational[]>> geoMinerResourcesInfo_BiomeAndEnvironmentKey = new HashMap<>();
    public static final List<SimplePair<BiomeAndEnvironment,SimplePair<ItemStack[],IntegerRational[]>>> geoResourcesInfo_BiomeAndEnvironmentKey_List = new ArrayList<>();
    public static final List<SimplePair<BiomeAndEnvironment,SimplePair<ItemStack[],IntegerRational[]>>> geoMinerResourcesInfo_BiomeAndEnvironmentKey_List = new ArrayList<>();
