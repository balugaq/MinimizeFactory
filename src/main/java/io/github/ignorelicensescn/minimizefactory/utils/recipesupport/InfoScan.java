...
//    }
    ...
    public static Set<TweakedMachineFuel> findFuels_InfinityExpansion_InfinityReactor(InfinityReactor sfItem){
        ...
        for (int i=0;i<infIngotAmount / 64;i+=1){
        ...
        for (int i=infIngotAmount / 64 + (infIngotAmount % 64 == 0 ? 0 : 1);i<Ingots.length - (voidIngotAmount % 64 == 0 ? 0 : 1);i+=1){
        ...
        result.add(new TweakedMachineFuel((LCM/2), Ingots, EMPTY_ITEM_STACK_ARRAY));
        return result;
    }
