...
public class InfinityExpansionConsts {
    ...
    public static final int HYDRO_ENERGY = -5;
    public static final int ADVANCED_HYDRO_ENERGY = -45;
    public static final int GEO_ENERGY = -35;
    public static final int ADVANCED_GEO_ENERGY = -210;
    public static final int BASIC_SOLAR_ENERGY = -9;
    public static final int ADVANCED_SOLAR_ENERGY = -150;
    public static final int CELESTIAL_ENERGY = -750;
    public static final int VOID_ENERGY = -3000;
    public static final int INFINITY_ENERGY = -60000;
    public static final int INFINITY_REACTOR_ENERGY = -120_000;

    public static final int INFINITY_INTERVAL = 196000;
    public static final int VOID_INTERVAL = 32000;
