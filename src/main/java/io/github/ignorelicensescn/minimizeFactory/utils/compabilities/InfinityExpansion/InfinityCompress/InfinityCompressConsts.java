package io.github.ignorelicensescn.minimizeFactory.utils.compabilities.InfinityExpansion.InfinityCompress;
...
public class InfinityCompressConsts {
     ...
     */
    public static Map<String, List<SimplePair<ItemStack[],ItemStack>>> multiblockAutocrafterRecipes = new HashMap<>();
